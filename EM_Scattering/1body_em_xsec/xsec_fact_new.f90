  ...
  subroutine cc1(xq,w,wt,xk,xp,ee0,theta,ig,sigma)
    ...
    integer*4 :: ig,i
    real*8 :: xq, w,wt, xk, xp, ee0,theta, sig, sigma
    real*8 :: ek,epf,xmf,Qsquared
    real*8 :: hphi,phi,xk_x,xk_y,xk_z
    real*8 :: p_4(4),pp_4(4),q_4(4),qt_4(4), cosa
...
!     sina2    sin(alpha)**2, alpha being the angle between the 
      ...
      do i=1,nphi
         ...
         pp_4(3)=xk_y
         pp_4(4)=xk_z+xq
         call current_init(p_4,pp_4,q_4,qt_4)
         call kin_vars(xq, Qsquared, wf)
         call define_spinors()
         call sigccc(sig,ig)
...
!.....compute sigma_mott [ fm^2 --> mb ]
      ...
      qm2 = q2-wf**2
      qmt2 = q2-wtf**2
      !...al,at are the leptonic factors multiplying R_L and R_T
      al=(-qm2/q2)**2
