...
subroutine det_Jpi(gep)
  ...
  return
   ...
   complex*16 :: j1ja(2,2,4),j1jb(2,2,4), j1jc(2,2,4),j1jd(2,2,4),res(4,4)
   real*8 :: res_re(4,4)
   ...
   do it2=1,1
    ...
    ctd = ctd + IDeltaD(nuc1_isospinor,t2(it2,:),t2(it2,:),nuc1_isospinor)
   enddo
...
subroutine det_JdelJdel_exc(res_re)
  ...
  ! res_re(4,4)=(w/q(4))**2*res_re(1,1)
   ...
   complex*16 :: j1jf(2,2,4),j1js(2,2,4),res(4,4)   
   real*8 :: res_re(4,4)
