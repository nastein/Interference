     subroutine nform(Q2,f_1p,f_1n,f_2p,f_2n,g1,gs,gp,fixed_axial)
...
!
    ...
    &       ,num_mn,den_mn,one,G_A,gan1,MAsq,mpi
     real*8 :: f_1p,f_1n,f_2p,f_2n,g1,gs,gp,fixed_axial
...
!
     ...
     subroutine z_exp_axial(q2,FA)
          ...
          real*8 :: q2, FA, FA0
          real*8 :: z, fixed_a(0:8), a_err(0:8),t0_optimal,tcut_choice
