...
subroutine det_Jpi(gep)
  ...
  return
   ...
   !Set t1 to 2 (looking at neutrons for this)
   do it2=1,2
        ctb = ctb + IDeltaB(t1(2,:),t2(it2,:),t2(it2,:),t1(1,:))
        ctc = ctc + IDeltaC(t1(2,:),t2(it2,:),t2(it2,:),t1(1,:))
   enddo

   write(6,*)'delta b isospin = ', ctb
   write(6,*)'delta c isospin = ', ctc
...
subroutine det_JdelJdel_exc(res_re)
  ...
  ! res_re(4,4)=(w/q(4))**2*res_re(1,1)
   ...
   do it2=1,2
        ctf = ctf + tauplus(t1(2,:),t2(it2,:),t2(it2,:),t1(1,:))
        cts = cts + tauplus(t1(2,:),t2(it2,:),t2(it2,:),t1(1,:))
        ctp = ctp + tauplus(t1(2,:),t2(it2,:),t2(it2,:),t1(1,:))
   enddo
...
function tauplus(it1,it2,itp1,itp2)
    implicit none
    complex*16 :: it1(2),it2(2),itp1(2),itp2(2)
    complex*16 :: tauplus

    tauplus = ci*(me(2,it1,itp1)*me(3,it2,itp2) - me(3,it1,itp1)*me(2,it2,itp2) + & 
        & ci*(me(3,it1,itp1)*me(1,it2,itp2) - me(1,it1,itp1)*me(3,it2,itp2)))

    !write(6,*)'it1 = ', it1, ' it2 = ', it2, ' itp1 = ', itp1, ' itp2 = ', itp2, ' tauplus = ', tauplus
...
function IDeltaA(it1,it2,itp1,itp2)
    implicit none
    complex*16 :: it1(2),it2(2),itp1(2),itp2(2)
    complex*16 :: IDeltaA, cpi, c

    cpi = tauplus(it1,it2,itp1,itp2)
...
function me(i,it,itp)
    ...
    !write(6,*)'me for t = ', it, ' and tp = ', itp, ': ', me
